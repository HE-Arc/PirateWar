...
urlpatterns = [
    ...
    path('play/delete-ship/<int:pk>', login_required(ShipDeleteView.as_view()), name='delete-ship'),
    path('play/create-ship/', login_required(ShipCreateView.as_view()), name='create-ship'),
